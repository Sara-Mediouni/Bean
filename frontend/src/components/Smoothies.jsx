    ...
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 hover:shadow-2xl transition">
          <img src="/images/smoothie-strawberry.jpg" alt="Strawberry Smoothie" className="rounded-2xl h-48 w-full object-cover mb-4" />
          ...
          <p className="text-brown-500 text-sm mb-3">Fresh strawberries, almond milk, Greek yogurt</p>
        ...
        {/* Smoothie Card - Mango */}
        <div className="bg-white rounded-3xl shadow-xl p-6 hover:shadow-2xl transition">
          <img src="/images/smoothie-mango.jpg" alt="Mango Smoothie" className="rounded-2xl h-48 w-full object-cover mb-4" />
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-2xl font-semibold text-orange-600">Mango Passion</h3>
            <span className="text-orange-500 font-bold">€5.20</span>
          </div>
          <p className="text-brown-500 text-sm mb-3">Mango, passion fruit, coconut milk</p>
          <div className="flex flex-wrap gap-2">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 hover:shadow-2xl transition">
          <img src="/images/smoothie-green.jpg" alt="Green Smoothie" className="rounded-2xl h-48 w-full object-cover mb-4" />
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-2xl font-semibold text-orange-600">Green Detox</h3>
            <span className="text-orange-500 font-bold">€5.00</span>
          </div>
          <p className="text-brown-500 text-sm mb-3">Spinach, green apple, kiwi, lime</p>
          <div className="flex flex-wrap gap-2">
